...
1. How would you describe acessibility on the web to someone new to programming?
   Being able to perceive, and navigate our website while on the web.
2. Talk about 3 different things you can do to ensure your website is accessible.
   Text alternatives for non text content - Example an images alt tag including a short description of the image in the alt attribute.
   <img src="dancingKittens.gif" alt="Kittens dancing.">
3. How would you explain the concept of a variable to someone new to programming?
   Basically a container to hold information, and store that data in memory.
4. What is the purpose of using functions in code?
   A block of coded that is used to perform an action.
