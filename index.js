...
artists who were born in and died in 20th century (1900-2000) example born in 1901 and died in 1959 - 
...
Create a function called `getHTML()` that takes the parameter `data` and 
uses a for..in loop to format and console.log data like the example above. 

The function should console.log 50 chunks of HTML code that match the structure above. 

‼️ You do **NOT** need to get these to display on your page, 
but you can copy and paste the result into your HTML file if you'd like to see what that would look like. */

function getHTML(data) {
  const element = document.querySelector("body > section.artists-container");
}
...
let refactorArray = artists.map((newArtists) => {
  deceased = artists[0];
  let rObj = {
    id: 13,
    name: "Mimic",
    ...
    nationality: "N/A",
    bio:
      "I'm a mimic from the galaxy Z23oD-OAA taking over every famous, and prolific artist in mans history.",
  };
